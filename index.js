const content = [
  [
    ...
    "It's powerful & flexuble",
    "It has very active and versatile ecosystem",
  ],
  [
...
function displayContent(items) {
  ...
  tabContent.append(list); //put the ul element inside the div element
}

function highlightButton(btn) {
  // Clear all exiting styleing / highlights
...
displayContent(content[0]); // intially show this content
